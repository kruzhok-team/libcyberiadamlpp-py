...
# 
#  A document geometry check test
# 
...
try:
    ...
    print("contained content check: {}".format(int(d.check_geometry())))
    d.open(sys.argv[0] + "-invalid.graphml", CyberiadaML.formatDetect, CyberiadaML.geometryFormatCyberiada10)
    print("escaping content check: {}".format(int(d.check_geometry())))
